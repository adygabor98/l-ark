...
export const ToastActions = ({ description, actionText, cancelText, actionColor = 'success', onConfirm, onCancel }: ToastActionsProps) => {
...
export const useToast = () => {
    ...
    const onConfirmationToast = (data: ToastConfirmationData): Promise<{ confirmed: boolean; dismiss: () => void }> => {
            ...
            toastId = sileo.action({
                ...
                description: (
                    <ToastActions
                        ...
                        onConfirm={() => resolve({ confirmed: true, dismiss })}
                        onCancel={() => { dismiss(); resolve({ confirmed: false, dismiss }); }}
                    />
                ),
                duration: null,
            });
