...
interface UseOperationBlueprintApiResponse {
    ...
    retrieveBlueprintById: (variables: { id: string }) => FetchResult<{ data: OperationBlueprintDetail }>;
...
export const useOperationBlueprint = (): UseOperationBlueprintApiResponse => {
    ...
    return {
        ...
        retrieveBlueprintById: (variables: { id: string }) => retrieveBlueprintById({ variables }) as FetchResult<{ data: OperationBlueprintDetail }>,
