...
/** Manage to render the glass card */
...
export const DirectorDashboard = (): ReactElement => {
    ...
    /** Compute the status distribution */
    ...
    const pendingCount = instances.filter(i => i.status === OperationInstanceStatus.COMPLETED_READY || i.status === OperationInstanceStatus.PENDING_PAYMENT).length;
