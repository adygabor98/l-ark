...
import { Users, Building, GitBranch, Bell, CheckCircle2, XCircle } from "lucide-react";
import { selectUser } from "../../../store/selectors/user.selector";
import { useUser } from "../../../server/hooks/useUser";
import { useOffice } from "../../../server/hooks/useOffice";
import { useDivision } from "../../../server/hooks/useDivision";
    ...
    return (
        <div className="space-y-8">
            ...
            <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">{today} · Welcome, {user?.firstName}</p>
            </div>
